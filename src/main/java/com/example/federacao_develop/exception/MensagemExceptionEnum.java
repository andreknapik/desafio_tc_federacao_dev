...
public enum MensagemExceptionEnum {
    ...
    ESTADIO_COM_CLUBES("Não é possível deletar o estádio pois existe pelomenos um clubes vinculados a ele. Para deletar este estádio, você precisa primeiro deletar os clubes associados a ele."),
    ESTADIO_COM_PARTIDAS("Não é possível deletar o estádio pois existem pelomenos um partidas marcadas para ele. Para deletar este estádio, você precisa primeiro deletar as partidas associadas a ele.");
